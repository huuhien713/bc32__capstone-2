...
var a = 5;
var b = 8;
var c = 5; // Các biểu thức so sánh sẽ trả về giá trị boolean
...
if (a > b) {
  console.log("Gi\xE1 tr\u1ECB a l\u1EDBn h\u01A1n gi\xE1 tr\u1ECB b");
} // Bài toán tính tiền phạt thẻ tín dụng


function tinhTienPhat() {
  //B1 DOM lấy các giá trị từ input
  var tagCreditCardBalance = Number(document.getElementById("creditCardBalance").value);
  var tagPayment = Number(document.getElementById("payment").value); //B2: tính số tiền còn nợ

  var balance = tagCreditCardBalance - tagPayment; //B3: Xử lí tính tiền phạt
...
if (x > y) {
  console.log("Gi\xE1 tr\u1ECB c\u1EE7a x l\u1EDBn h\u01A1n gi\xE1 tr\u1ECB c\u1EE7a y");
} else {
  console.log("Gi\xE1 tr\u1ECB c\u1EE7a y l\u1EDBn h\u01A1n gi\xE1 tr\u1ECB c\u1EE7a x");
...
document.getElementById("tinhTien").onclick = function () {
  ...
  document.getElementById("tienLuong").value = tienLuong.toLocaleString() + " VND";
}; // If - Else If - Else;
// var x = 4;
// var y = 6;
...
document.getElementById("tinhToan").onclick = function () {
  ...
  document.getElementById("tienTra").value = thanhTien.toLocaleString() + " VND";
}; // Toán tử bật 3 (Ternary operator)


var age = 16; // var message = "";
// if (age >= 18) {
//   message = "welcome";
// } else {
//   message = "Not allowed";
...
console.log(message); //Toán tử logic: &&(AND) , ||(OR) , !(NOT)

var tuoi = 15;
var hasTicket = true; // &&(AND):
